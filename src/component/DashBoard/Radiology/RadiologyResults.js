...
export default function Prescriptions() {
    ...
    useEffect(() => {
        getAllResults(
            apiUrl + 'lab-radiology/view-radiology-request/'
        );
    }, []);
                    ...
                    <div className={classes.cover}>
                        <diV className={classes.billBox}>
                            ...
                            <div className={classes.name}>
                                ...
                                {result.radiology_request && result.radiology_request.length > 0 ? (
                                    <div className={classes.data}>{result.radiology_request[0].exam.name}</div>
                                ) : (
